...
const MainPage = () => {
  return (
      <main >
          <h1 className="mt-5 text-center border rounded shadow p-3 mb-5 bg-body rounded">Welcome to DocFinder</h1>
        <section1>
            <div className="container mt-5">
                <div className="row justify-content-between">
                    <div className="col-4 text-center border rounded pt-4 pb-5 shadow p-3 mb-5 bg-body rounded">
